    ...
    if (data && data.length === 0) {
        return (
            <ApiLoading message="You haven't received any roles yet.">
                <p>
                    This is where you can see the roles you have been sent and
                    if they passed your filters or not.
                </p>
                <p>
                    If you like you can submit a job to yourself to test what
                    will happen when a recruiter submits an role to you.
                </p>
                <Link
        ...
        <div className="mb-8">
            <div className="overflow-hidden bg-white shadow sm:rounded-md">
                <div className="px-4 py-5 sm:px-6">
                    ...
                    <p className="pb-6">
                        These are the roles you've received from people using
                        your sharing link.
                    </p>
