...
export function StripeCheckoutSessionRequestDtoFromJSON(
    json: any,
): StripeCheckoutSessionRequestDto {
    return StripeCheckoutSessionRequestDtoFromJSONTyped(json, false);
}

export function StripeCheckoutSessionRequestDtoFromJSONTyped(
    json: any,
    ...
    return {
        organisationUuid: !exists(json, "organisationUuid")
            ? undefined
            : json["organisationUuid"],
        lineItems: (json["lineItems"] as Array<any>).map(
            StripeCheckoutLineItemFromJSON,
        ),
        mode: json["mode"],
        successFrontendPath: json["successFrontendPath"],
        cancelFrontendPath: !exists(json, "cancelFrontendPath")
            ? undefined
            : json["cancelFrontendPath"],
    };
}

export function StripeCheckoutSessionRequestDtoToJSON(
    value?: StripeCheckoutSessionRequestDto | null,
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        lineItems: (value.lineItems as Array<any>).map(
            StripeCheckoutLineItemToJSON,
        ),
        mode: value.mode,
