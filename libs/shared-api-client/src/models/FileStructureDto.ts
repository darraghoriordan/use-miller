...
export function FileStructureDtoFromJSONTyped(
    json: any,
    ...
    return {
        ...
        children: !exists(json, "children")
            ? undefined
            : (json["children"] as Array<any>).map(FileStructureDtoFromJSON),
    };
}
    ...
    return {
        ...
        children:
            value.children === undefined
                ? undefined
                : (value.children as Array<any>).map(FileStructureDtoToJSON),
    };
}
