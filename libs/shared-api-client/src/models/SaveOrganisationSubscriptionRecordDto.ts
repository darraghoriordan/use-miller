...
export function SaveOrganisationSubscriptionRecordDtoFromJSON(
    json: any,
): SaveOrganisationSubscriptionRecordDto {
    return SaveOrganisationSubscriptionRecordDtoFromJSONTyped(json, false);
}

export function SaveOrganisationSubscriptionRecordDtoFromJSONTyped(
    json: any,
    ...
    return {
        ...
        millerPaymentReferenceUuid: !exists(json, "millerPaymentReferenceUuid")
            ? undefined
            : json["millerPaymentReferenceUuid"],
...
export function SaveOrganisationSubscriptionRecordDtoToJSON(
    value?: SaveOrganisationSubscriptionRecordDto | null,
): any {
    if (value === undefined) {
        return undefined;
    }
