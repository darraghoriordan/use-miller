...
export function UserFromJSONTyped(
    ...
    return {
        ...
        familyName: !exists(json, "familyName")
            ? undefined
            : json["familyName"],
        givenName: !exists(json, "givenName") ? undefined : json["givenName"],
        picture: !exists(json, "picture") ? undefined : json["picture"],
        auth0UserId: !exists(json, "auth0UserId")
            ? undefined
            : json["auth0UserId"],
        username: !exists(json, "username") ? undefined : json["username"],
        memberships: !exists(json, "memberships")
            ? undefined
            : (json["memberships"] as Array<any>).map(
                  OrganisationMembershipFromJSON,
              ),
        apiKeys: !exists(json, "apiKeys")
            ? undefined
            : (json["apiKeys"] as Array<any>).map(UserApiKeyFromJSON),
    ...
    return {
        ...
        memberships:
            value.memberships === undefined
                ? undefined
                : (value.memberships as Array<any>).map(
                      OrganisationMembershipToJSON,
                  ),
        apiKeys:
            value.apiKeys === undefined
                ? undefined
                : (value.apiKeys as Array<any>).map(UserApiKeyToJSON),
