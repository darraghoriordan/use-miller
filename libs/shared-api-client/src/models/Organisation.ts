...
export function OrganisationFromJSONTyped(
    ...
    return {
        id: json["id"],
        uuid: json["uuid"],
        subscriptionRecords: !exists(json, "subscriptionRecords")
            ? undefined
            : (json["subscriptionRecords"] as Array<any>).map(
                  OrganisationSubscriptionRecordFromJSON,
              ),
        name: json["name"],
...
export function OrganisationToJSON(value?: Organisation | null): any {
    ...
    return {
        ...
        uuid: value.uuid,
        subscriptionRecords:
            value.subscriptionRecords === undefined
                ? undefined
                : (value.subscriptionRecords as Array<any>).map(
                      OrganisationSubscriptionRecordToJSON,
                  ),
        name: value.name,
