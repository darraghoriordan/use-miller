...
export function OrganisationSubscriptionRecordFromJSON(
    json: any,
): OrganisationSubscriptionRecord {
    return OrganisationSubscriptionRecordFromJSONTyped(json, false);
}

export function OrganisationSubscriptionRecordFromJSONTyped(
    json: any,
...
export function OrganisationSubscriptionRecordToJSON(
    value?: OrganisationSubscriptionRecord | null,
): any {
    if (value === undefined) {
        return undefined;
    }
