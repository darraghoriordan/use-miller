...
import { Person, PersonFromJSON, PersonFromJSONTyped, PersonToJSON } from "./";
...
export function UpdateOrganisationDtoFromJSON(
    json: any
): UpdateOrganisationDto {
    return UpdateOrganisationDtoFromJSONTyped(json, false);
}

export function UpdateOrganisationDtoFromJSONTyped(
    json: any,
    ...
    return {
        ...
        owner: !exists(json, "owner")
            ? undefined
            : PersonFromJSON(json["owner"]),
        name: !exists(json, "name") ? undefined : json["name"],
    };
}

export function UpdateOrganisationDtoToJSON(
    value?: UpdateOrganisationDto | null
): any {
    if (value === undefined) {
        return undefined;
    }
