...
export function StripeCustomerPortalResponseDtoFromJSON(
    json: any,
): StripeCustomerPortalResponseDto {
    return StripeCustomerPortalResponseDtoFromJSONTyped(json, false);
}

export function StripeCustomerPortalResponseDtoFromJSONTyped(
    json: any,
...
export function StripeCustomerPortalResponseDtoToJSON(
    value?: StripeCustomerPortalResponseDto | null,
): any {
    if (value === undefined) {
        return undefined;
    }
