...
export interface PersonsApiInterface {
     ...
     * @memberof PersonsApiInterface
     */
    personControllerRemoveRaw(
        requestParameters: PersonControllerRemoveRequest
    ): Promise<runtime.ApiResponse<Person>>;

    /**
     */
    personControllerRemove(
        requestParameters: PersonControllerRemoveRequest
    ): Promise<Person>;
     ...
     * @memberof PersonsApiInterface
     */
    personControllerUpdateRaw(
        requestParameters: PersonControllerUpdateRequest
    ): Promise<runtime.ApiResponse<Person>>;
...
export class PersonsApi extends runtime.BaseAPI implements PersonsApiInterface {
    ...
    /**
     */
    async personControllerRemoveRaw(
        requestParameters: PersonControllerRemoveRequest
    ): Promise<runtime.ApiResponse<Person>> {
        if (
            ...
            throw new runtime.RequiredError(
                "uuid",
                "Required parameter requestParameters.uuid was null or undefined when calling personControllerRemove."
            );
        }
    ...
    /**
     */
    async personControllerRemove(
        requestParameters: PersonControllerRemoveRequest
    ): Promise<Person> {
        const response = await this.personControllerRemoveRaw(
            requestParameters
        );
        return await response.value();
    }
    ...
    /**
     */
    async personControllerUpdateRaw(
        requestParameters: PersonControllerUpdateRequest
    ): Promise<runtime.ApiResponse<Person>> {
        if (
            requestParameters.uuid === null ||
            ...
            throw new runtime.RequiredError(
                "uuid",
                "Required parameter requestParameters.uuid was null or undefined when calling personControllerUpdate."
            );
        }
        ...
        if (
            ...
            throw new runtime.RequiredError(
                "body",
                "Required parameter requestParameters.body was null or undefined when calling personControllerUpdate."
            );
        }
    ...
    /**
     */
    async personControllerUpdate(
        requestParameters: PersonControllerUpdateRequest
    ): Promise<Person> {
        const response = await this.personControllerUpdateRaw(
            requestParameters
        );
        return await response.value();
    }
