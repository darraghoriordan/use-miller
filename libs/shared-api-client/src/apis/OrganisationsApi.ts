    ...
    implements OrganisationsApiInterface
{
    ...
    async organisationControllerFindOne(
        ...
        const response =
            await this.organisationControllerFindOneRaw(requestParameters);
        return await response.value();
    }
    ...
    async organisationControllerRemove(
        ...
        const response =
            await this.organisationControllerRemoveRaw(requestParameters);
        return await response.value();
    }
    ...
    async organisationControllerUpdate(
        ...
        const response =
            await this.organisationControllerUpdateRaw(requestParameters);
        return await response.value();
    }
}
