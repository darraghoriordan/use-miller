...
export default function useGetFileContent(courseKey: string, filePath: string, enabled: boolean, apiOptions: ApiOptions): import("@tanstack/react-query").UseQueryResult<FileMetaDto, unknown>;
